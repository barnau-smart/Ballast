...
- [ ] [Review][HIGH] AC5 (honest framing) entirely missing — `narrate.py` untouched: the coach says "deploy $65,949" with no "this sells your SWVXX; your $40k reserve stays untouched." **FIX: narration + allow-set aware of the settlement-vs-MM split + protected reserve.** — **STILL OPEN (the remaining rework item; touches the 10-3 never-invent-a-number validator + frontend — its own focused pass).**
